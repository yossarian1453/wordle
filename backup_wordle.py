...
if re.match('[-]', guess_1_yellow_df[0]):
    yellow_position_1 = ''
    query1 = f"""
        SELECT * 
...
if re.match('[-]', guess_1_yellow_df[1]):
    yellow_position_2 = ''
    query2 = f"""
        SELECT * 
...
if re.match('[-]', guess_1_yellow_df[2]):
    yellow_position_3 = ''
    query3 = f"""
        SELECT * 
...
if re.match('[-]', guess_1_yellow_df[3]):
    yellow_position_4 = ''
    query4 = f"""
        SELECT * 
...
if re.match('[-]', guess_1_yellow_df[4]):
    yellow_position_5 = ''
    query5 = f"""
        SELECT * 
...
guess_2_yellow_df
if re.match('[-]', guess_2_yellow_df[0]):
    yellow_position_1 = ''
    query1 = f"""
        SELECT * 
        FROM words_df1_green
...
if re.match('[-]', guess_2_yellow_df[1]):
    yellow_position_2 = ''
    query2 = f"""
        SELECT * 
        FROM words_yellow_df1
...
if re.match('[-]', guess_2_yellow_df[3]):
    yellow_position_4 = ''
    query4 = f"""
        SELECT * 
        FROM words_yellow_df3
...
if re.match('[-]', guess_2_yellow_df[4]):
    yellow_position_5 = ''
    query5 = f"""
        SELECT * 
        FROM words_yellow_df4
...
guess_3_yellow_df
if re.match('[-]', guess_3_yellow_df[0]):
    yellow_position_1 = ''
    query1 = f"""
        SELECT * 
        FROM words_df1_green
...
if re.match('[-]', guess_3_yellow_df[1]):
    yellow_position_2 = ''
    query2 = f"""
        SELECT * 
        FROM words_yellow_df1
...
if re.match('[-]', guess_3_yellow_df[2]):
    yellow_position_3 = ''
    query3 = f"""
        SELECT * 
        FROM words_yellow_df2
...
if re.match('[-]', guess_3_yellow_df[3]):
    yellow_position_4 = ''
    query4 = f"""
        SELECT * 
        FROM words_yellow_df3
...
if re.match('[-]', guess_3_yellow_df[4]):
    yellow_position_5 = ''
    query5 = f"""
        SELECT * 
        FROM words_yellow_df4
